...
<<<<<<< HEAD
var ValidStocks = []string{"AAPL", "TSLA", "GOOG", "AMZN", "NVDA", "MSFT", "META", "COST", "DIS", "NFLX", "PLTR", "WMT", "LMT"}                                               // Stocks accepted for everything
var ValidStocksNames = []string{"Apple", "Tesla", "Google", "Amazon", "Nvidia", "Microsoft", "Meta", "Costco", "Disney", "Netflix", "Palantir", "Walmart", "Lockheed Martin"} // The names of those stocks
=======
...
>>>>>>> 9461e86b3f486a9af199ec4af035deec2a79a5de
